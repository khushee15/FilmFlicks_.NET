                ...
                <div class="contact-form-card">
                    ...
                    <div class="row g-3">
                        <div class="col-12 col-md-6">
                            <label for="senderName" class="form-label">Your Name <span class="text-danger">*</span></label>
                            <asp:TextBox ID="txtSenderName" runat="server" CssClass="form-control" placeholder="John Doe" required></asp:TextBox>
                        </div>

                        <div class="col-12 col-md-6">
                            <label for="senderEmail" class="form-label">Email Address <span class="text-danger">*</span></label>
                            <asp:TextBox ID="txtSenderEmail" runat="server" TextMode="Email" CssClass="form-control" placeholder="john@example.com" required></asp:TextBox>
                        </div>

                        <div class="col-12">
                            <label for="subject" class="form-label">Subject <span class="text-danger">*</span></label>
                            <asp:DropDownList ID="ddlSubject" runat="server" CssClass="form-select" required>
                                <asp:ListItem Value="" Text="Choose a Subject" Selected="True" Disabled="True"></asp:ListItem>
                                <asp:ListItem Value="General Inquiry" Text="General Inquiry"></asp:ListItem>
                                <asp:ListItem Value="Report Broken Link" Text="Report Broken Link"></asp:ListItem>
                                <asp:ListItem Value="DMCA / Copyright Notice" Text="DMCA / Copyright Notice"></asp:ListItem>
                                <asp:ListItem Value="Advertisement / Partnership" Text="Advertisement / Partnership"></asp:ListItem>
                            </asp:DropDownList>
                        </div>

                        <div class="col-12">
                            <label for="messageContent" class="form-label">Your Message <span class="text-danger">*</span></label>
                            <asp:TextBox ID="txtMessageContent" runat="server" TextMode="MultiLine" Rows="5" CssClass="form-control" placeholder="Type your message here..." required></asp:TextBox>
                        </div>

                        <div class="col-12 text-end mt-4">
                            <asp:Button ID="btnSubmit" runat="server" Text="Send Message" CssClass="btn btn-crimson px-5 py-2 fw-bold w-100 w-md-auto" OnClick="btnSubmit_Click" />
                        </div>
                    </div>
                </div>
            </div>
