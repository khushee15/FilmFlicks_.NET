<%@ Page Title="Cartoon & Anime - FilmFlicks" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Cartoon.aspx.cs" Inherits="WebApplication1.Cartoon" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <main class="container" style="padding-top: 100px;">
        ...
        <!-- Dynamic Cartoons Section -->
        <section class="mb-5">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h3 class="fw-bold m-0 border-start border-4 border-warning ps-3">Popular Cartoon & Anime Series</h3>
            </div>
            ...
            <div class="row g-4">
                    ...
                    <ItemTemplate>
                        <div class="col-12 col-sm-6 col-lg-3">
                            <div class="movie-card">
                                <span class="rating-badge"><i class="bi bi-star-fill"></i> <%# string.IsNullOrEmpty(Eval("ImdbID").ToString()) ? "IMDb" : Eval("ImdbID") %></span>
                                ...
                                <div class="movie-overlay">
                                    ...
                                    <p class="text-white-50 small mb-2"><%# Eval("Director") %></p>
                                    <a href='<%# "cartoon-details.aspx?id=" + Eval("CartoonID") %>' class="btn btn-crimson btn-sm w-100">
                                        <i class="bi bi-play-fill me-1"></i>View Details
                                    </a>
                                </div>
                            </div>
                        </div>
                ...
                <asp:Panel ID="pnlNoCartoons" runat="server" Visible="false" CssClass="col-12 text-center py-5">
                    <div class="alert alert-dark text-white-50 p-4 rounded-3 border-secondary">
                        <i class="bi bi-film fs-1 text-warning d-block mb-3"></i>
                        <h4 class="text-white fw-bold">No Cartoons Added Yet</h4>
                        <p>Cartoons will appear here as soon as they are added from Admin Dashboard.</p>
                    </div>
                </asp:Panel>
            </div>
        </section>
        ...
        <div class="container">
            <div class="row g-4 mb-4">
                <div class="col-lg-4">
                    ...
                    <p class="text-white-50 mt-3 small">FilmFlicks is a premier platform for high-quality cartoon, anime, movie, and web series downloads.</p>
                </div>
            </div>
