...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <!-- MAIN WEBSERIES DETAILS CONTENT -->
    <main class="container" style="padding-top: 100px;">
        
        <!-- DYNAMIC WEBSERIES DATA REPEATER -->
        <asp:Repeater ID="rptWebSeriesDetails" runat="server">
            <ItemTemplate>
                <!-- Hero Banner Section -->
                    ...
                    <div class="row g-4 align-items-center">
                        ...
                        <div class="col-12 col-md-8 col-lg-9">
                            ...
                            <div class="row g-3 text-white-50 mb-4 small">
                                <div class="col-sm-6">
                                    <p class="mb-1"><strong class="text-white"><i class="bi bi-person-video2 me-2"></i>Director / Creator:</strong> <%# Eval("Director") %></p>
                ...
                <section class="mb-5">
                    <h3 class="fw-bold mb-4 border-start border-4 border-primary ps-3">Web Series Screenshots & Preview</h3>
                    <div class="row g-3">
                ...
                <!-- Dynamic Episode Download Links Table -->
                <section id="download-section" class="mb-5">
                    ...
                    <div class="glass-card table-responsive p-3">
                        <table class="table align-middle text-white mb-0">
                            ...
                            <tbody>
                                <tr>
                                    <td><span class="badge bg-success">Batch / Zip (Server 1)</span></td>
                                    <td><%# Eval("QualityTag") %></td>
                                    <td><a href='<%# Eval("DownloadLink1") %>' target="_blank" class="btn btn-crimson btn-sm"><i class="bi bi-cloud-arrow-down me-1"></i>Download All Episodes</a></td>
                                </tr>
                                <tr>
                                    <td><span class="badge bg-primary">Single Episodes (Server 2)</span></td>
                                    <td><%# Eval("QualityTag") %></td>
                                    <td><a href='<%# Eval("DownloadLink2") %>' target="_blank" class="btn btn-crimson btn-sm"><i class="bi bi-cloud-arrow-down me-1"></i>Mirror Download Link</a></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
