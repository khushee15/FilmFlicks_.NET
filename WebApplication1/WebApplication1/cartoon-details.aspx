<%@ Page Title="Cartoon Details - FilmFlicks" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="cartoon-details.aspx.cs" Inherits="WebApplication1.cartoon_details" %>
            ...
            <div class="collapse navbar-collapse" id="navContent">
                ...
                <div class="d-flex align-items-center gap-3">
                    <div class="input-group" style="max-width: 240px;">
                        <input type="text" id="navSearchQuery_cd" class="form-control bg-dark text-white border-secondary" placeholder="Search cartoons..." onkeydown="if(event.key === 'Enter'){ performNavSearch_cd(); return false; }">
                        <button class="btn btn-outline-secondary" type="button" onclick="performNavSearch_cd()"><i class="bi bi-search"></i></button>
                    </div>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    <!-- MAIN CARTOON DETAILS CONTENT -->
    <main class="container" style="padding-top: 100px;">
        
        <!-- DYNAMIC CARTOON DATA REPEATER -->
        <asp:Repeater ID="rptCartoonDetails" runat="server">
            <ItemTemplate>
                <!-- Hero Banner Section -->
                    ...
                    <div class="row g-4 align-items-center">
                        ...
                        <div class="col-12 col-md-8 col-lg-9">
                            <div class="d-flex flex-wrap gap-2 mb-3">
                                <span class="meta-tag text-warning border-warning"><i class="bi bi-star-fill me-1"></i>IMDb <%# string.IsNullOrEmpty(Eval("ImdbID").ToString()) ? "8.5" : Eval("ImdbID") %></span>
                                <span class="meta-tag"><i class="bi bi-collection me-1"></i>Cartoon Series</span>
                                <span class="meta-tag"><i class="bi bi-translate me-1"></i>Hindi / Dual Audio</span>
                            </div>

                            <h1 class="display-4 fw-bold text-white mb-3"><%# Eval("Title") %></h1>
                            
                            <div class="d-flex flex-wrap gap-2 mb-4">
                                <span class="badge bg-warning text-dark"><%# Eval("Director") %></span>
                            ...
                            <div class="row g-3 text-white-50 mb-4 small">
                                <div class="col-sm-6">
                                    <p class="mb-1"><strong class="text-white"><i class="bi bi-person-video2 me-2"></i>Creator/Director:</strong> <%# Eval("Director") %></p>
                                    <p class="mb-1"><strong class="text-white"><i class="bi bi-people me-2"></i>Voice Cast:</strong> <%# Eval("Cast") %></p>
                                </div>
                                <div class="col-sm-6">
                            ...
                            <div class="d-flex gap-3 flex-wrap">
                                <a href="#download-section" class="btn btn-crimson btn-lg fs-6"><i class="bi bi-download me-2"></i>Download Episodes</a>
                ...
                <section id="trailer-section" class="mb-5">
                    <h3 class="fw-bold mb-4 border-start border-4 border-warning ps-3">Official Trailer</h3>
                ...
                <section class="mb-5">
                    <h3 class="fw-bold mb-4 border-start border-4 border-primary ps-3">Screenshots & Preview</h3>
                    <div class="row g-3">
                ...
                <section id="download-section" class="mb-5">
                    <h3 class="fw-bold mb-4 border-start border-4 border-success ps-3">High-Speed Episode Download Links</h3>
        ...
        <section class="mb-5">
            ...
            <div class="glass-card p-4">
                ...
                <div class="mb-5">
                    ...
                    <asp:Label ID="lblReviewMsg" runat="server" CssClass="d-block mb-3"></asp:Label>
                    <div class="mb-3">
                        ...
                        <ItemTemplate>
                            <div class="review-card mb-3 pb-3 border-bottom border-secondary">
                                <div class="d-flex align-items-center justify-content-between mb-2">
                                    <h6 class="fw-bold text-white m-0"><i class="bi bi-person-circle text-primary me-2"></i><%# Eval("UserName") %></h6>
                                </div>
                                <p class="text-white-50 small mb-1"><%# Eval("CommentText") %></p>
                                <span class="text-muted" style="font-size: 0.75rem;"><%# Eval("CommentDate", "{0:dd MMM yyyy HH:mm}") %></span>
                            </div>
                        </ItemTemplate>
                    </asp:Repeater>
                    
                    <asp:Panel ID="pnlNoComments" runat="server" Visible="false" CssClass="text-center text-white-50 py-3">
