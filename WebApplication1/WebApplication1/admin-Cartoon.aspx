<%@ Page Title="Manage Cartoon - FilmFlicks Admin" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="admin-Cartoon.aspx.cs" Inherits="WebApplication1.admin_Cartoon" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <nav class="admin-sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li><a href="admin-Cartoon.aspx" class="active"><i class="bi bi-collection-play-fill"></i> <span>Manage Cartoon</span></a></li>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    ...
    <main class="admin-main-content">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4 pb-3 border-bottom border-secondary border-opacity-25">
            <div>
                <h3 class="fw-bold text-white mb-1">Cartoon Catalog Management</h3>
                <p class="text-white-50 small mb-0">Add new cartoons, anime, update download links, media files and manage cartoon library.</p>
            </div>
        </div>
        ...
        <!-- ADD/EDIT CARTOON FORM CARD -->
        <div class="admin-card">
            <div class="card-header-title">
                <span>Add / Edit Cartoon Details</span>
            </div>
            
            <asp:HiddenField ID="hfCartoonID" runat="server" Value="0" />

            <div class="row g-3">
                <!-- Basic Info -->
                <div class="col-md-8">
                    <label class="form-label">Cartoon Title</label>
                    <asp:TextBox ID="txtTitle" runat="server" CssClass="form-control" placeholder="e.g. Doraemon / Naruto / Tom and Jerry"></asp:TextBox>
                </div>
                <div class="col-md-4">
                ...
                <div class="col-md-4">
                    ...
                    <asp:DropDownList ID="ddlQuality" runat="server" CssClass="form-select">
                        ...
                        <asp:ListItem Text="Dual Audio Hindi" Value="Dual Audio Hindi"></asp:ListItem>
                    </asp:DropDownList>
                </div>
                <div class="col-md-4">
                    <label class="form-label">Creator / Director</label>
                    <asp:TextBox ID="txtDirector" runat="server" CssClass="form-control" placeholder="e.g. Fujiko F. Fujio"></asp:TextBox>
                </div>
                <div class="col-md-4">
                    <label class="form-label">Voice Cast</label>
                    <asp:TextBox ID="txtCast" runat="server" CssClass="form-control" placeholder="e.g. Wasabi Mizuta, Megumi Oohara"></asp:TextBox>
                </div>
                ...
                <!-- Description -->
                <div class="col-12">
                    <label class="form-label">Cartoon Description</label>
                    <asp:TextBox ID="txtDescription" runat="server" TextMode="MultiLine" Rows="3" CssClass="form-control" placeholder="Write storyline / episode summary..."></asp:TextBox>
                </div>

                <!-- Action Buttons -->
                <div class="col-12 mt-4">
                    <asp:Button ID="btnSave" runat="server" Text="Save Cartoon" CssClass="btn btn-primary-purple me-2" OnClick="btnSave_Click" />
                    <asp:Button ID="btnCancel" runat="server" Text="Cancel / Reset" CssClass="btn btn-secondary-dark" OnClick="btnCancel_Click" />
                </div>
            </div>
        </div>

        <!-- CARTOONS LIST TABLE CARD -->
        <div class="admin-card">
            <div class="card-header-title">
                <span>Existing Cartoons Directory</span>
            </div>
            <div class="table-responsive">
                <asp:Repeater ID="rptAdminCartoons" runat="server" OnItemCommand="rptAdminCartoons_ItemCommand">
                    <HeaderTemplate>
                    ...
                    <ItemTemplate>
                        <tr>
                            <td class="fw-bold text-white-50">#<%# Eval("CartoonID") %></td>
                            <td>
                            ...
                            <td><span class="badge bg-warning text-dark px-2 py-1"><%# Eval("QualityTag") %></span></td>
                            <td class="text-end">
                                <asp:LinkButton ID="btnEdit" runat="server" CommandName="Edit" CommandArgument='<%# Eval("CartoonID") %>' CssClass="action-btn-warning me-1" ToolTip="Edit Cartoon">
                                    <i class="bi bi-pencil"></i>
                                </asp:LinkButton>
                                <asp:LinkButton ID="btnDelete" runat="server" CommandName="Delete" CommandArgument='<%# Eval("CartoonID") %>' CssClass="action-btn-danger" OnClientClick="return confirm('Are you sure you want to delete this cartoon?');" ToolTip="Delete Cartoon">
