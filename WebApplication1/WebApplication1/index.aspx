...
<asp:Content ID="Content9" runat="server" contentplaceholderid="ContentPlaceHolder1">
    ...
    <head>
        ...
        <title>FilmFlicks - Unlimited Movies & Web Series Download</title>
    ...
    <body>
        <nav class="navbar navbar-expand-lg fixed-top glass-nav navbar-dark">
            <div class="container">
                <a class="navbar-brand fw-bold fs-3" href="index.aspx" style="background: var(--accent-gradient); -webkit-background-clip: text; -webkit-text-fill-color: transparent;"><i class="bi bi-film me-2 text-primary"></i>FilmFlicks </a>
                ...
                <div class="collapse navbar-collapse" id="navContent">
                    ...
                    <div class="d-flex align-items-center gap-3">
                        <div class="input-group" style="max-width: 240px;">
                            <input type="text" id="navSearchQuery_index" class="form-control bg-dark text-white border-secondary" placeholder="Search movies, series..." onkeydown="if(event.key === 'Enter'){ performNavSearch_index(); return false; }">
                            <button class="btn btn-outline-secondary" type="button" onclick="performNavSearch_index()"><i class="bi bi-search"></i></button>
                        </div>
...
<asp:Content ID="Content11" runat="server" contentplaceholderid="ContentPlaceHolder2">
    <main class="container" style="padding-top: 100px;">
        ...
        <section class="mb-5">
            ...
            <div class="row g-4">
                <asp:Repeater ID="rptHomeMovies" runat="server" OnItemCommand="rptHomeMovies_ItemCommand">
                    <ItemTemplate>
                        <div class="col-12 col-sm-6 col-lg-3">
                            <div class="movie-card">
                                ...
                                <div class="movie-overlay">
                                    ...
                                    <a href='<%# "movie-details.aspx?id=" + Eval("MovieID") %>' class="btn btn-crimson btn-sm w-100">
        ...
        <div class="container">
            <div class="row g-4 mb-4">
                <div class="col-lg-4">
                    ...
                    <p class="text-white-50 mt-3 small">FilmFlicks is a premier platform for high-quality movie downloads.</p>
                </div>
            </div>
            <hr class="border-secondary my-4">
            <div class="text-center text-white-50 small">© 2026 FilmFlicks. All rights reserved.</div>
        </div>
    </footer>
